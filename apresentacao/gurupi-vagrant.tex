...
\begin{lstlisting}
  def situacao
    return :sem_acordo if dividas_pendentes?
    return :com_atraso if dividas_em_atraso?
    return :quitado if dividas_quitadas?
    return :em_dia
  end
\end{lstlisting}
\end{frame}
...
%\usebackgroundtemplate{%
  %\vbox to \paperheight{
    %\vfil\hbox to \paperwidth{
      %\hfil\includegraphics[width=5cm]{trollface.jpg}\hfil
    %}\vfil
  %}
%}
...
%{\usebackgroundtemplate{
  %\vbox to \paperheight{
    %\vfil\hbox to \paperwidth{
      %\hfil\includegraphics[width=5cm]{trollface-lascou.jpg}\hfil
    %}\vfil
  %}
%}
%\begin{frame}[plain]
